...
void loop()
{
    for (float u = 0.887; u < 10.666 ; u = u + 0.887)    
    {
...
//        Serial.println("------------------------");
        ...
        correction1_4 = map(abs(c1_4), 0, 30, 0, 70);     //50
...
//        Serial.println("------------------------");
    ...
    for (float t = 0.523, u = 0.89; t < PI, u < 5.34 ; t = t + 0.523, u = u + 0.887)
    {

      float xe_3 = 4 + 8*cos(t);
      float ye_3 = -45 + 6*sin(t);
...
//        Serial.println("------------------------");
    ...
    for (float t = 0.523, u = 0.89; t < PI, u < 5.34 ; t = t + 0.523, u = u + 0.887)
    {
      ...
      float xe_4 = 2 + 8*cos(t);
      float ye_4 = -45 + 6*sin(t);
