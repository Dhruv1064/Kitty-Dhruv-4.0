...
//    c1_1 = Kp1 * error1_1 + Kd1 * (dif_error1_1);
    ...
    correction2_1 = map(abs(c2_1), 0, 90, 0, 200);//150
    }
    else
    {
      correction1_1 = map(abs(c1_1), 0, 70, 0, 80);
    correction2_1 = map(abs(c2_1), 0, 90, 0, 210);//150
    }
    
//    correction1_1 = map(abs(c1_1), 0, 70, 0, 65);
//    correction2_1 = map(abs(c2_1), 0, 90, 0, 150);      //175
...
//    c1_1 = Kp1 * error1_1 + Kd1 * (dif_error1_1);
    ...
    correction1_1 = map(abs(c1_1), 0, 30, 0, 40);       //50
    correction2_1 = map(abs(c2_1), 0, 35, 0, 150);      //175
    ...
    correction2_2 = map(abs(c2_2), 0, 90, 0, 200);//150
    }
    else
    {
      correction1_2 = map(abs(c1_2), 0, 70, 0, 80);
    correction2_2 = map(abs(c2_2), 0, 90, 0, 210);//150
    }
...
//          Serial.println(ye_2);
  ...
  for (double u = 0.887 ; u < 10.666 ; u = u + 0.887)
  {
