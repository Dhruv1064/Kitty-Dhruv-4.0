...
double theta1AT1_1 = 52.20, theta1AT2_1 = 45.94, theta1AT3_1 = 67.52, theta1_AT1_1 = 0, theta1_AT2_1 = 0.1, theta1_AT3_1 = 0, theta1__AT1_1 = 0, theta1__AT2_1 = 0.1, theta1__AT3_1 = 0;
...
double theta1AT1_2 = 54.45, theta1AT2_2 = 48.34, theta1AT3_2 = 68.91, theta1_AT1_2 = 0, theta1_AT2_2 = 0.1, theta1_AT3_2 = 0, theta1__AT1_2 = 0, theta1__AT2_2 = 0.1, theta1__AT3_2 = 0;
...
double theta1AT1_3 = 52.21, theta1AT2_3 = 45.94, theta1AT3_3 = 67.52, theta1_AT1_3 = 0, theta1_AT2_3 = 0.1, theta1_AT3_3 = 0, theta1__AT1_3 = 0, theta1__AT2_3 = 0.1, theta1__AT3_3 = 0;
...
double theta1AT1_4 = 54.45, theta1AT2_4 = 48.34, theta1AT3_4 = 68.91, theta1_AT1_4 = 0, theta1_AT2_4 = 0.1, theta1_AT3_4 = 0, theta1__AT1_4 = 0, theta1__AT2_4 = 0.1, theta1__AT3_4 = 0;
...
void loop(){
  for (double t = 0.1, u = 1; t <= 1.01, u <= 10.01; t = t + 0.1, u = u + 1)
  {
    double xe_2 = 4 - u ;
    double ye_2 = -43 ;
...
//3
    ...
    if(t<0.5)
    c1_1 = PID(theta1_1, theta1c_1, zeroError1_1 , Kp1+1.2 , Kd1+1.6 , prev_error1_1);    
    else
    c1_1 = PID(theta1_1, theta1c_1, zeroError1_1 , Kp1+1.4 , (Kd1+2.1) , prev_error1_1);
    c2_1 = PID(theta2_1, theta2c_1, zeroError2_1 , Kp2+0.6 , Kd2 , prev_error2_1);
    ll1=0.0, lm1=70.0, ul1=45.0, um1 = 51.0;
    ...
    ll1=0.0, lm1=70.0, ul1=33.0, um1=38.0;
    ...
    correction2_1 = (um2-ul2)/(lm2-ll2)*abs(c2_1) + ul2;      //TODO
      ...
      ll2=0.0, lm2=70.0, ul2=110.0, um2=130.0;
...
//    theta2_2 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_2 * xe_2 + ye_2 * ye_2), l1, l2));
    ...
    ll1=0.0, lm1=40.0, ul1=29.5, um1=35.0;
    ll2=0.0, lm2=90.0, ul2=20.0, um2=40.0;
...
//    theta2_3 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_3 * xe_3 + ye_3 * ye_3), l1, l2));
    ...
    c2_3 = PID(theta2_3, theta2c_3, zeroError2_3 , Kp2 , Kd2+2.4 , prev_error2_3);

    ll1=0.0, lm1=40.0, ul1=28, um1=35.0;    
    ll2=0.0, lm2=90.0, ul2=20.0, um2=37.0;
    ...
    ll1=0.0, lm1=70.0, ul1=42.0, um1=48.0;
...
//    correction1_4 = (um1-ul1)/(lm1-ll1)*abs(c1_4)+ul1;
    ...
    ll1=0.0, lm1=70.0, ul1=28, um1=35.0;
    correction1_4 = (um1-ul1)/(lm1-ll1)*abs(c1_4)+ul1;      //TODO   0-60
    }
    
    if(t<0.5){
    ll2=0.0, lm2=70.0, ul2=120.0, um2=180.0;
    correction2_4 = (um2-ul2)/(lm2-ll2)*abs(c2_4) + ul2;      //TODO
    }
    else{
      ll2=0.0, lm2=70.0, ul2=70.0, um2=90.0;
...
//    theta2_1 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_1 * xe_1 + ye_1 * ye_1), l1, l2));
    ...
    c2_1 = PID(theta2_1, theta2c_1, zeroError2_1 , Kp2 , Kd2+1.5 , prev_error2_1);

    ll1=0.0, lm1=40.0, ul1=23, um1=34.0;    
    ll2=0.0, lm2=90.0, ul2=20.0, um2=30.0;
    ...
    if(t<0.5)
    c1_2 = PID(theta1_2, theta1c_2, zeroError1_2 , Kp1+2.2 , Kd1+1.5 , prev_error1_2);
    else
    c1_2 = PID(theta1_2, theta1c_2, zeroError1_2 , Kp1+1.5 , (Kd1+1.8) , prev_error1_2);
    c2_2 = PID(theta2_2, theta2c_2, zeroError2_2 , Kp2+1.6 , Kd2+0.9 , prev_error2_2);
    ll1=0.0, lm1=70.0, ul1=42.0, um1 = 50.0;
//    correction1_2 = (um1-ul1)/(lm1-ll1)*abs(c1_2)+ul1;
    
    if(t<0.5)
    correction1_2 = (um1-ul1)/(lm1-ll1)*abs(c1_2)+ul1;
    else{
    ll1=0.0, lm1=70.0, ul1=35.0, um1= 40.0;
    correction1_2 = (um1-ul1)/(lm1-ll1)*abs(c1_2)+ul1;      //TODO   0-60
    }
    
    if(t<0.5){
    ll2=0.0, lm2=70.0, ul2=120.0, um2=170.0;
    correction2_2 = (um2-ul2)/(lm2-ll2)*abs(c2_2) + ul2;      //TODO
    }
    else{
      ll2=0.0, lm2=70.0, ul2=40.0, um2=80.0;
    correction2_2 = (um2-ul2)/(lm2-ll2)*abs(c2_2) + ul2;
    }
...
//    if(t==0.4 || t==0.5 || t==0.6) correction1_2 = 45;
    ...
    if(t<0.5)
    c1_3 = PID(theta1_3, theta1c_3, zeroError1_3 , Kp1+1.9 , Kd1+1.3 , prev_error1_3);
    else
    ...
    ll1=0.0, lm1=70.0, ul1=42.0, um1=54.0;
    ...
    correction2_3 = (um2-ul2)/(lm2-ll2)*abs(c2_3) + ul2;      //TODO
      ...
      ll2=0.0, lm2=70.0, ul2=100.0, um2=140.0;
    correction2_3 = (um2-ul2)/(lm2-ll2)*abs(c2_3) + ul2;
    }
...
//    theta2_4 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_4 * xe_4 + ye_4 * ye_4), l1, l2));
    ...
    c1_4 = PID(theta1_4, theta1c_4, zeroError1_4 , (Kp1+1.65) , (Kd1+1.8) , prev_error1_4);
    c2_4 = PID(theta2_4, theta2c_4, zeroError2_4 , Kp2 , Kd2+1.5 , prev_error2_4);

    ll1=0.0, lm1=30.0, ul1=22, um1=30;
    ll2=0.0, lm2=40.0, ul2=18.0, um2=25.0;
