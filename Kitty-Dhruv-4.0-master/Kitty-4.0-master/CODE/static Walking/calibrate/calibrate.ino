...
void loop(){
  for (double t = 0.1, u = 1.6; t <= 1.1, u <= 16.1; t = t + 0.1, u = u + 1.6)
  {
    ...
    ll1=0.0, lm1=40.0, ul1=55, um1=90.0;    
    ll2=0.0, lm2=90.0, ul2=100.0, um2=210.0;
...
//    correction1_1=um1;
    ...
    ll1=0.0, lm1=40.0, ul1=50, um1=100.0;    
    ll2=0.0, lm2=90.0, ul2=100.0, um2=200.0;
...
//    if(t>0.75) correction1_3 = 32;
    ...
    ll1=0.0, lm1=30.0, ul1=55, um1=105;
    ll2=0.0, lm2=40.0, ul2=90.0, um2=200.0;
...
//-------------------------------------------------------------------------------------------------------
  ...
  { 
    ...
    ll1=0.0, lm1=40.0, ul1=55, um1=105.0;    
    ll2=0.0, lm2=90.0, ul2=100.0, um2=210.0;
