...
void loop()
{
        for (float t = 0.523, u=0.89;t < 3.139,u < 5.34; t = t + 0.523,u = u + 0.88){
...
//        Serial.println("------------------------");
        ...
        for (float t = 0.523, u=0.89;t < 3.139,u < 5.34; t = t + 0.523,u = u + 0.88)       //0.01
        {
...
//        Serial.println("------------------------");
        ...
        for (float u=0.89 ; u < 10.68 ; u = u + 0.88)
        {
